...
class Runner:
    ...
    def validate_mesh(self, world_space=False, resolution=64, threshold=0.0):
        bound_min = jittor.array(self.dataset.object_bbox_min, dtype=jittor.float32)
        bound_max = jittor.array(self.dataset.object_bbox_max, dtype=jittor.float32)
