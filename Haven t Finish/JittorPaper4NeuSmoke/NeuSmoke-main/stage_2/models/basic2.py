...
class SRNet(nn.Module):
    ...
    def execute(self, tgt_img,tgt_depth,tgt_time,ref_imgs,ref_depths,ref_poses,intrinsics,intrinsics_inv):
        ...
        rgbs = jt.stack(predis)
        alphas = jt.stack(confs)
        alphas = nn.softmax(alphas, dim=0)
